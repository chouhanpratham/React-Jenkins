...
const ProductDetails = () => {
  ...
  const productObj = products.find((p) => p.id === parseInt(id));
  ...
  return (
    <div>
      ...
      <img src={productObj.image} alt={productObj.name} height={200} />
      <p>
        <strong>Category:</strong> {productObj.category}
      </p>
      <p>
        <strong>Description:</strong> {productObj.description}
      </p>
      <p>Thank you for visiting, {user.name}!</p>
      <hr />
